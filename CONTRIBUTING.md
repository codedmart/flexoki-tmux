# Contributing to flexoki-tmux

Thank you for your interest in contributing to the flexoki-tmux project! We welcome contributions from the community to help improve and enhance the project. To ensure a smooth collaboration process, please follow the guidelines outlined below.
...
1. **Fork the Repository**: Fork the flexoki-tmux repository to your own GitHub account.
...
7. **Open a Pull Request**: Open a pull request from your branch to the `next` branch of the main flexoki-tmux repository. Provide a clear title and description for your pull request, explaining the changes you have made and referencing any related issues.
...
Thank you for your contribution to flexoki-tmux! We appreciate your effort and look forward to collaborating with you.
