...
# title      Flexoki                                                  +
# version    1.0.0                                                    +
# repository https://github.com/codedmart/flexoki-tmux                +
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
terminal_icon="$(echo "$TMUX_VARS" | grep '@flexoki-tmux_terminal_icon' | cut -d" " -f2)"
active_terminal_icon="$(echo "$TMUX_VARS" | grep '@flexoki-tmux_active_terminal_icon' | cut -d" " -f2)"
window_tidy="$(echo "$TMUX_VARS" | grep '@flexoki-tmux_window_tidy_icons' | cut -d" " -f2)"
